                        ...
                        for dy, dx in [(-1,0), (1,0), (0,-1), (0,1)]:
                            if np.random.random() < EXPANSION_PROB:
                                if new_grid[y+dy, x+dx] == 0:
                                    new_grid[y+dy, x+dx] = max(10, heat - 40)
                                    self.num_cells2 += 1
...
start_button = col1.button("Démarrer")
stop_button = col2.button("Arrêter")
...
if start_button:
    ...
    while True:
        ...
        time.sleep(0.25) # Petit délai pour laisser le navigateur respirer
